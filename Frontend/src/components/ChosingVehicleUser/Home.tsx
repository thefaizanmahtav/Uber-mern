...
function Home() {
    ...
    return (
            ...
            <div className="overflow-y-hidden">
                ...
                <div className="relative top-16 py-1 lg:top-25 md:px-10 xl:px-[65px] px-4.5">
                    ...
                    <div className="lg:flex lg:pb-10 gap-10">
                        ...
                        <div className="w-full lg:h-[90vh] block rounded-lg lg:rounded-none overflow-hidden">
                            <img
                                ...
                                className="h-[440px] w-full lg:h-full object-cover"
                            />
                        </div>
