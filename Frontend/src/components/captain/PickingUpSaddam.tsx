...
function PickingUpSaddam() {
    ...
    const NavToOtpVerify = (e: any) => {
        e.preventDefault();
        setActive(false)

        setTimeout(() => {
            const path = "/captains/dashboard/pickup-rider/veriefy-OTP"
            navigate(path)
        }, 500)
                ...
                <div className="lg:flex flex-row-reverse">
                    ...
                    >
                        ...
                        <div className="px-6 py-3.5">
                            ...
                            <div onClick={NavToOtpVerify}
                                className="flex items-center w-full bg-emerald-700 rounded-md p-2 mt-4 overflow-hidden cursor-pointer">
...
export default PickingUpSaddam
