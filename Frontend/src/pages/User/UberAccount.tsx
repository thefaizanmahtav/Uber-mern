        ...
        <>
            ...
            <div className="lg:flex"> {/* Wrapeer */}
                ...
                <div className={clsx(
                    ...
                    ["info", "security", "privacy"].includes(activeTab) && "lg:w-78"
                )}>

                    {
                        ["home", "info", "security", "privacy"].map((tab) => (
                            <button
                                key={tab}
                                onClick={() => {
                                    setActiveTab(tab);
                                ...
                                className={clsx(
                                    "flex text-[15px] lg:text-[16px] font-semibold py-4 px-8 transition-all duration-500 lg:duration-0 border-b-[7px] lg:border-l-[6px] lg:border-b-0 outline-none max-lg:hover:bg-gray-100",
                                    activeTab === tab
